    ...
    return Scaffold(
        ...
        body: Container(
          ...
          Container(
              ...
              child: const Text(timeValue,style: TextStyle(
                      fontSize: 50,
                      color: Color.fromARGB(255, 153, 155, 132)))),
          Container(
              child: Row(
                ...
                AddTimeValue(time: '+5', min: 'min'),
                Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: AddTimeValue(time: '+15', min: 'sec'),
                ),
              ])),
          Divider(
            color: Colors.black,
...
class AddTimeValue extends StatelessWidget {
  ...
  const AddTimeValue(
      {super.key, required this.time, required this.min, required this.onTap});
...
Inkwell({required Function onTap, required Container child}) {
}
